...
CREATE TABLE IF NOT EXISTS `rpg`.`postac` (
  ...
  INDEX `fk_postac_lokacja1_idx` (`nazwalokacja` ASC),
  INDEX `fk_postac_user1_idx` (`login` ASC),
  CONSTRAINT `fk_postac_lokacja1`
    FOREIGN KEY (`nazwalokacja`)
    REFERENCES `rpg`.`lokacja` (`nazwalokacja`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `rpg`.`npc` (
  ...
  `nazwalokacja` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idnpc`),
  INDEX `fk_npc_lokacja1_idx` (`nazwalokacja` ASC),
...
CREATE TABLE IF NOT EXISTS `rpg`.`potwor` (
  ...
  INDEX `fk_potwor_lokacja1_idx` (`nazwalokacja` ASC),
